...
export default function AnxietyBurnoutPage() {
  ...
  const t = {
    ...
    en: {
      ...
      p1: 'Constant inner tension, a sense of anxiety without a clear reason, tiredness even after rest, difficulty concentrating, irritability, and the feeling that you have less and less energy — these are some of the reasons many people come to therapy.',
      p2: 'Sometimes anxiety appears as an endless stream of thoughts, a sense of inner danger, tension in the body, sleep difficulties, or a constant ожидание that something bad is about to happen. Emotional burnout may feel like emptiness, loss of sensitivity to life, exhaustion from people, work, and even from yourself.',
      p3: 'In therapy, we can gently explore what is maintaining this state: chronic stress, high inner pressure, inability to rest without guilt, suppressed emotions, old survival strategies, or living in constant internal tension.',
      ...
      item4: 'fear of mistakes, overload, feeling “I can’t cope anymore”',
